...
module.exports = function (opts) {
  ...
  try {
    ...
    let componentFiles = [
      `components/${platform}/ui.${platform}.js`,
      `components/common/ui.common.js`]
    let featureFiles = glob.sync(`/features/**/*.feature`)
    let configFile = path.join(process.cwd(), '/config/config.json')
    ...
    require(path.join(__dirname, '/utils/yaml-components')).mapToPatata(opts)
