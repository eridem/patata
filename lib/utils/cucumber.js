...
module.exports = function (opts) {
  ...
  const createArgs = () => {
    ...
    var componentsArgs = buildWithArgs(process.cwd() + '/', currentSuite.components, '--require')
    var implementationArgs = buildWithArgs(process.cwd() + '/', currentSuite.include, '--require')
