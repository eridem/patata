...
module.exports = function (argv, log, exampleFolder) {
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      cp(path.join(exampleFolder, '/create-feature', '/feature-example.ios.js'), path.join(featurePath, `/${featureFolderName}.ios.js`))
      cp(path.join(exampleFolder, '/create-feature', '/feature-example.common.js'), path.join(featurePath, `/${featureFolderName}.common.js`))
